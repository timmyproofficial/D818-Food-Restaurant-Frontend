...
const CheckoutOrderPaypalPage: React.FC = () => {
    ...
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-center justify-end mx-auto pt-[25px] w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex flex-col gap-3.5 items-start justify-start max-w-[1324px] mt-[9px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row gap-[25px] items-start justify-between md:ml-[0] ml-[3px] w-full">
              <div className="flex md:flex-1 flex-col gap-5 items-center justify-start md:mt-0 mt-[5px] w-3/4 md:w-full">
                <div className="bg-gray-100 flex flex-col gap-6 items-center justify-center p-9 sm:px-5 rounded-[10px] w-full">
                  <div className="flex flex-col items-start justify-start mt-1.5 w-full">
                    ...
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between ml-0.5 md:ml-[0] mt-5 w-full">
                      ...
                      <div className="bg-gray-50 border border-red-700 border-solid flex flex-row gap-3 items-center justify-center p-3.5 rounded-[7px]">
                        ...
                        <div className="bg-amber-A400 h-[15px] mr-[5px] my-1.5 rounded-[7px] w-[15px]"></div>
                      </div>
                      <div
              ...
              <div className="bg-gray-100 flex md:flex-1 flex-col justify-center mb-[230px] p-3.5 rounded-[10px] w-[24%] md:w-full">
                <Text
...
export default CheckoutOrderPaypalPage;
