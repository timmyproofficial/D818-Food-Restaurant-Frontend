    ...
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-center justify-end mx-auto pt-[25px] w-full">
        ...
        <div className="flex flex-col gap-5 items-center justify-start max-w-[1323px] mt-[18px] mx-auto md:px-5 w-full">
          <div className="bg-gray-100 flex flex-col items-center justify-start p-8 sm:px-5 rounded-[10px] w-full">
            <div className="flex sm:flex-col flex-row sm:gap-10 gap-[90px] items-center justify-center w-[35%] md:w-full">
              <Img
                className="h-[145px] w-[145px]"
                src="images/img_alerticon.svg"
                alt="alerticon"
              />
              <div className="flex flex-col gap-[7px] items-center justify-start pt-0.5 px-0.5 w-[46%] sm:w-full">
                <Text
                ...
                <Button className="bg-red-700 cursor-pointer font-semibold leading-[normal] min-w-[161px] py-[7px] text-[15px] text-center text-white-A700_01">
                  Try Again
                </Button>
              </div>
            </div>
