  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-center justify-end mx-auto pt-[25px] w-full">
        ...
        <div className="flex flex-col gap-5 items-center justify-start max-w-[1322px] mt-[18px] mx-auto md:px-5 w-full">
          <div className="bg-gray-100 flex flex-col items-center justify-start p-11 md:px-10 sm:px-5 rounded-[10px] w-full">
            <div className="flex md:flex-col flex-row md:gap-10 gap-[90px] items-center justify-center w-[54%] md:w-full">
              <Img
              ...
              <div className="flex flex-col items-center justify-start w-[68%] md:w-full">
                <div className="flex flex-col gap-[13px] items-start justify-start w-full">
                  ...
                  >
                    Your Payment is being processed, wait for confirmation
                  </Text>
                </div>
              </div>
            </div>
