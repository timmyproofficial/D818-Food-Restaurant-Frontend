...
const CheckoutOrderStripePage: React.FC = () => {
    ...
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-center justify-end mx-auto pt-[25px] w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex flex-col gap-[18px] items-start justify-start max-w-[1325px] mt-[9px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row gap-6 items-start justify-between md:ml-[0] ml-[5px] w-full">
              <div className="flex md:flex-1 flex-col gap-5 items-center justify-start w-3/4 md:w-full">
                <div className="bg-gray-100 flex flex-col items-center justify-start p-[35px] sm:px-5 rounded-[10px] w-full">
                  <div className="flex flex-col items-start justify-start my-[3px] pb-[3px] w-full">
                    <div className="flex flex-col font-poppins items-start justify-start w-full">
                      ...
                      <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between ml-0.5 md:ml-[0] mt-5 w-full">
                        <div
                          className="common-pointer bg-gray-50 flex flex-row items-center justify-start p-3.5 rounded-[29px]"
                        ...
                        <div className="bg-gray-50 border border-red-700 border-solid flex flex-row items-center justify-center p-[13px] rounded-[7px]">
                          <Img
                          ...
                          <div className="bg-amber-A400 h-[15px] ml-5 mr-[7px] my-2 rounded-[7px] w-[15px]"></div>
                        </div>
                        <Img
                    ...
                    <div className="flex md:flex-col flex-row font-inter gap-[30px] items-center justify-between mt-[15px] w-full">
                    ...
                    <div className="flex md:flex-col flex-row font-inter gap-[30px] items-center justify-between mt-3.5 w-full">
                    ...
                    <Text
                      className="ml-1 md:ml-[0] mt-[21px] text-[16.56px] text-gray-900"
          ...
          <Footer className="flex items-center justify-center mt-[35px] md:px-5 w-full" />
        </div>
      </div>
    </>
  );
...
export default CheckoutOrderStripePage;
