    ...
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-center justify-end mx-auto pt-[25px] w-full">
        <div className="flex flex-col gap-[41px] items-center justify-start w-full">
          <div className="flex flex-col items-start justify-start max-w-[1330px] mx-auto md:px-5 w-full">
            <Header className="flex md:flex-col flex-row md:gap-5 items-center justify-center md:ml-[0] ml-[7px] w-full" />
            <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between mt-1.5 w-[66%] md:w-full">
              <Img
                className="common-pointer h-[54px] sm:mt-0 mt-[3px]"
                src="images/img_arrowleft.svg"
                alt="arrowleft"
                onClick={() => navigate(-1)}
              />
              <div className="flex flex-row items-center justify-between w-[49%] sm:w-full">
            ...
            <div className="flex md:flex-col flex-row gap-6 items-start justify-between md:ml-[0] ml-[5px] mt-[26px] w-full">
              <div className="flex md:flex-1 flex-col gap-5 items-center justify-start md:mt-0 mt-1 w-3/4 md:w-full">
              ...
              <div className="bg-gray-100 flex md:flex-1 flex-col justify-center mb-[140px] p-3.5 rounded-[10px] w-[24%] md:w-full">
                <Text
